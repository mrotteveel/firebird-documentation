...
[NOTE]
====
If you need to do a case-insensitive search for something _enclosed inside_ a string (`++LIKE '%Abc%'++`), use of the <<fblangref50-commons-predcontaining>> predicate is recommended.
====
