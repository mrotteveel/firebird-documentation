...
[[fblangref30-commons-expressions]]
== Expressions
...
[[fblangref30-dtyp-tbl-exprelements]]
...
Context variable::
An internally-defined <<fblangref30-contextvars,context variable>>
...
[[fblangref30-commons-string-constant]]
==== String Literals
...
[[fblangref30-commons-hexstrings]]
...
Strings entered this way will have character set `OCTETS` by default, but the <<fblangref30-commons-introducer-syntax,[term]_introducer syntax_>> can be used to force a string to be interpreted as another character set.
...
[[fblangref30-commons-introducer-syntax]]
...
[[fblangref30-commons-number-constant]]
==== Number Literals
...
[[fblangref30-commons-hexnumbers]]
...
[[fblangref30-dtyp-tbl-operpreced]]
...
[[fblangref30-commons-arith]]
==== Arithmetic Operators

[[fblangref30-dtyp-tbl-arithpreced]]
...
[[fblangref30-commons-compar]]
==== Comparison Operators

[[fblangref30-dtyp-tbl-comparpreced]]
...
.See also
<<fblangref30-commons-othercomppreds,Other Comparison Predicates>>.

[[fblangref30-commons-logical]]
==== Logical Operators

[[fblangref30-dtyp-tbl-logical]]
...
.See also
<<fblangref30-ddl-sequence,SEQUENCE (GENERATOR)>>, <<fblangref30-scalarfuncs-gen-id,`GEN_ID()`>>

[[fblangref30-commons-conditional]]
...
All other conditional expressions apply internal functions derived from `CASE` and are described in  <<fblangref30-functions-conditional,Conditional Functions>>.

[[fblangref30-commons-conditional-case]]
==== `CASE`
...
[[fblangref30-commons-conditional-case-simple]]
===== Simple `CASE`
...
A short form of the simple `CASE` construct is the <<fblangref30-scalarfuncs-decode,`DECODE`>>  function.

[[fblangref30-commons-conditional-case-srched]]
===== Searched `CASE`
...
[[fblangref30-commons-null-in-expr]]
=== `NULL` in Expressions
...
[[fblangref30-commons-returningnull]]
...
[[fblangref30-commons-nullinlogical]]
...
[[fblangref30-commons-subqueries]]
=== Subqueries
...
[[fblangref30-commons-correlatedsq]]
...
[[fblangref30-commons-predicates]]
== Predicates
...
For the complete list of comparison operators with their variant forms, see <<fblangref30-commons-compar,Comparison Operators>>.
...
----
+
-- see <<fblangref30-commons-isnotnull>>.
...
[[fblangref30-commons-othercomppreds]]
...
[[fblangref30-commons-escapechar]]
...
So, if you need to search for the beginning of a string, it is recommended to use the <<fblangref30-commons-predstartwith>> predicate instead of the `LIKE` predicate.
====
...
[NOTE]
====
If you need to do a case-insensitive search for something _enclosed inside_ a string (`LIKE '%Abc%'`), use of the <<fblangref30-commons-predcontaining>> predicate is recommended, in preference to the `LIKE` predicate.
====
...
.See also
<<fblangref30-commons-predstartwith,`STARTING WITH`>>, <<fblangref30-commons-predcontaining,`CONTAINING`>>, <<fblangref30-commons-predsimilarto,`SIMILAR TO`>>

[[fblangref30-commons-predstartwith]]
===== `STARTING WITH`
...
.See also
<<fblangref30-commons-predlike,`LIKE`>>

[[fblangref30-commons-predcontaining]]
===== `CONTAINING`
...
[[fblangref30-commons-predsimilarto]]
===== `SIMILAR TO`
...
[[fblangref30-commons-syntaxregex]]
...
Feel free to skip it and read the next section, <<fblangref30-commons-buildregex,Building Regular Expressions>>, which uses a bottom-up approach, aimed at the rest of us.
...
[float]
[[fblangref30-commons-regexwildcards]]
====== Wildcards
...
[float]
[[fblangref30-commons-regexcharclass]]
====== Character Classes
...
[float]
[[fblangref30-commons-regexpredefclass]]
...
[float]
[[fblangref30-commons-regexquantifiers]]
====== Quantifiers
...
[float]
[[fblangref30-commons-regexoring]]
====== OR-ing Terms
...
[float]
[[fblangref30-commons-regexsubexpr]]
====== Subexpressions
...
[float]
[[fblangref30-commons-regexescap]]
...
.See also
<<fblangref30-commons-isnotnull>>, <<fblangref30-commons-isnotboolean>>

[[fblangref30-commons-isnotboolean]]
===== Boolean `IS [NOT]`
...
[[fblangref30-commons-existential]]
=== Existential Predicates
...
.See also
<<fblangref30-commons-exists,EXISTS>>

[[fblangref30-commons-singular]]
==== `SINGULAR`
...
[[fblangref30-commons-quantifiedsq]]
