...
* Documented `RDB$GET_CONTEXT` `SYSTEM` variables `CLIENT_OS_USER` and `CLIENT_VERSION`
* Documented `STARTS` as alias for `STARTING` and that `WITH` is optional (https://github.com/FirebirdSQL/firebird-documentation/issues/235[#235])
